...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   return ChangeNotifierProvider(builder:  (ctx) => Places(),child:MaterialApp(
      title: 'Flutter Demo',
      theme: ThemeData(
...
class _LoginState extends State<Login> {
  ...
  {
     if(account != null){
     Navigator.push(context,MaterialPageRoute(builder: (context) => MyHomePage(account.id)));
     print('billa');
      }
  }
  void create () async
  {
    ...
    DocumentSnapshot d=await Firestore.instance.collection('Users').document(user.id).get();
    if(!d.exists)
    {
      await Navigator.push(context,MaterialPageRoute(builder: (context) => Register())).then((username) {
        u=username;
    ...
    print('kutta');
     Navigator.push(context,MaterialPageRoute(builder: (context) => MyHomePage(user.id)));
