                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              CircleAvatar(
                                backgroundImage:
                                    NetworkImage(result[index]['icon']),
                                radius: 20,
                              ),
                              SizedBox(
                                width: 5,
                    ...
                    style: TextStyle(
                        ...
                        color: Colors.grey),
                          ...
                          Container(
                            ...
                            child: Image.network(
                              (result[index]['photos'] != null)
                                  ? 'https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference=${result[index]['photos'][0]['photo_reference']}&key=AIzaSyCS90XB-jQMIhQbA2C9vzfWKETNaxpjWJo'
                                  : "",
                              fit: BoxFit.fill,
                            ),
                          ),
